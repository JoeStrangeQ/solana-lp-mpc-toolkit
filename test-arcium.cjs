...
console.log(
  "   Public key:",
  Buffer.from(keyPair.publicKey).toString("hex").slice(0, 32) + "...",
);
...
console.log(
  "   Collateral:",
  Buffer.from(encryptedCollateral).toString("hex").slice(0, 32) + "...",
);
console.log(
  "   Debt:",
  Buffer.from(encryptedDebt).toString("hex").slice(0, 32) + "...",
);
console.log(
  "   Health:",
  Buffer.from(encryptedHealth).toString("hex").slice(0, 32) + "...",
);

// Decrypt to verify round-trip
const decryptedCollateral = decryptValue(
  encryptedCollateral,
  sharedSecret,
  nonce,
);
