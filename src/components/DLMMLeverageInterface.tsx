...
import { DLMM_POOLS, getPoolInfo, getAvailablePools } from '../services/dlmmService';
...
const DLMMLeverageInterface: React.FC = () => {
  ...
  }, [publicKey, selectedPool, signTransaction, validation, connection, baseAsset, amount, leverage, binRange]);
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 space-y-6">
      ...
      <div className="text-center">
        ...
        <p className="text-gray-400">Open leveraged positions on Meteora DLMM</p>
      </div>
      ...
      <div className="bg-gray-800 rounded-xl p-6 space-y-6">
        ...
        <div>
          <label className="block text-sm text-gray-400 mb-2">Deposit Asset</label>
          ...
          <div className="bg-gray-900 rounded-lg p-4 space-y-2">
            ...
            <div className="flex justify-between">
              ...
              <span className={`font-mono ${
                estimatedHealth > 1.5 ? 'text-green-400' :
                estimatedHealth > 1.2 ? 'text-yellow-400' : 'text-red-400'
              }`}>
              ...
              >
                ...
                <div className="text-right">
                  ...
                  <div className={`text-sm ${
                    pos.status === 'healthy' ? 'text-green-400' :
                    pos.status === 'warning' ? 'text-yellow-400' : 'text-red-400'
                  }`}>
